...
public class RegistradorDeItens {
    ...
    private Item registrarItem(){
        ...
        estoqueMin=loopCheck("Qual a quantidade minima em estoque desse produto? (Obrigatorio ser maior que 0)", 
                            "Quantidade invalida, tente novamente!", 
                            0, 
                            scanner);
        
        estoqueMax=loopCheck("Qual a quantidade maxima em estoque desse produto? (Obrigatorio ser maior que a quantidade minima)", 
                            "Quantidade invalida, tente novamente!", 
                            estoqueMin, 
                            scanner);
                        
        i=loopCheck("Qual o tipo de Item do produto registrado?"+
                           " \n [1]-Acessorio"+
